...
import { GAUGE_COLORS, CATEGORY_COLORS } from "../assets/color";
import { useOutletContext } from 'react-router-dom';
import { ArrowDown, BarChart2, ChevronDown, ChevronUp, TrendingUp as ProfitIcon, PieChart as PieChartIcon, IndianRupee, PiggyBank, Plus, ShoppingCart, TrendingDown, TrendingUp, Wallet } from 'lucide-react';
import { getPreviousTimeFrameRange, getTimeFrameRange, calculateData } from '../components/Helpers';
...
const API_BASE = "https://expensesiq.onrender.com/api";
...
const INCOME_CATEGORY_ICONS = {
  Salary: <IndianRupee className="w-4 h-4 text-green-600" />,
  Other: <IndianRupee className="w-4 h-4 text-green-600" />
};

const EXPENSE_CATEGORY_ICONS = {
  Food: <ShoppingCart className="w-4 h-4 text-orange-600" />,
  Other: <ShoppingCart className="w-4 h-4 text-orange-600" />
};
...
const Dashboard = () => {
 ...
 //  filter for time 
  ...
  //  update the gauge when time frame chnages
  ...
  const displayIncome =
    timeFrame === "monthly" && typeof overviewMeta.monthlyIncome === "number" && overviewMeta.monthlyIncome > 0
    
      ? overviewMeta.monthlyIncome
      : currentTimeFrameData.income;

  const displayExpenses =
    timeFrame === "monthly" && typeof overviewMeta.monthlyExpense === "number" && overviewMeta.monthlyExpense > 0
  ...
  return (
    ...
    <div className={dashboardStyles.container}>
      ...
      <FinancialCard 
        ...
        additionalContent={
          <div 
            className="mt-2 text-xs text-cyan-600 flex items-center gap-2">
    ...
    {/* Expense distribution pie - Hidden on mobile */}
      <div className={dashboardStyles.pieChartContainer}>
        ...
        <div className={dashboardStyles.pieChartHeight} style={{ width: '100%', height: '360px', minWidth: '300px' }} >
