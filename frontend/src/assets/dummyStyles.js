...
export const navbarStyles = {
  ...
  container: "flex items-center justify-between px-4 py-3 md:px-8 max-w-8xl mx-auto bg-gradient-to-r from-cyan-500/50 to-teal-500/50 backdrop-blur-lg",

  
  // Logo styles
  logoContainer: "flex items-center gap-0 cursor-pointer ml-15 md:ml-20",
  logoImage: "w-15 h-15 mr-2 mb-1 mt-1 rounded-xl overflow-hidden",
  
  // Text styles
  logoText: "lg:text-4xl md:text-4xl text-3xl text-gray-900 font-[550] lobster-regular",
  
  // User profile styles
  userContainer: "relative",
  userButton: "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors mr-15 md:mr-20",
