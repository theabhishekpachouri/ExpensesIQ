...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
    ...
    // click outside  sidebar the collaps
    useEffect(() => {
                    ...
                    <div className=" flex items-center">
                        ...
                        {!isCollapsed && (
                            ...
                            >
                                ...
                                <p className="text-xs  text-grey-500 truncate"> {email} </p>
                            ...
                            <div className="relative h-full flex flex-col">
                                <div className={sidebarStyles.mobileHeader}>
                                    <div className={sidebarStyles.mobileUserContainer}>
                                        ...
                                        <div>
                                            <h2 className="text-1g font-bold text-gray-800">
                                                {username}
                                            </h2>
                                ...
                                <div className="flex-1 overflow-y-auto py-y">
